...
// // ives, pour la double précision
// double *io_png_read_d64(const char *fname, size_t *nxp, size_t *nyp);
// double *io_png_read_d64_rgb(const char *fname, size_t *nxp, size_t *nyp);
// double *io_png_read_d64_gray(const char *fname, size_t *nxp, size_t *nyp);
// int io_png_write_d64(const char *fname, const float *data, size_t nx, size_t ny, size_t nc);
