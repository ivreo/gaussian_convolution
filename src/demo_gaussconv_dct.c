...
void print_usage()
{
    fprintf(stderr, "DEMO semigroup DCT convolution  \n");
    fprintf(stderr, "gaussconv_dct in sigma N out  \n");
...
int main(int argc, char **argv)
{
    ...
    // direct
    gaussconv_dct(x, y1, w, h, sqrt((double)N)*sigma);
